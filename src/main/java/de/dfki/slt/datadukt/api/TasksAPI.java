...
public class TasksAPI{
	...
	/**
	 * Method to retrieve the list of existing Tasks in Datadukt
	 * @param taskId If specified, only the information related to Task=taskId is listed
	 * @return A JSON object containing the available Tasks in Datadukt
	 * @throws Exception
	 */
	...
	/**
	 * Method to create a new Task in Datadukt
	 * @param taskId Identification for the task (optional). If not provided, Datadukt will automatically generate one. 
